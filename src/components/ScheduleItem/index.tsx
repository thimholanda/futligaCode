...
const ScheduleItem: React.FC<ScheduleItemProps> = ({data}) => {
    ...
    const avatar = useMemo(() => {
        ...
        return (
          `${urls.distintivos}${scheduleInfo.equipe.distintivo}`
        );
      }, [scheduleInfo, urls]);
    ...
    const timeSchedule = checkZero(dateSchedule.getHours().toString())+":"+checkZero(dateSchedule.getMinutes().toString())
    ...
    return (
      <Container>
        <View style={{
            ...
            <AdjustableImage style={{flex: 1, width: 150,height: 100}} size="100%" isUri={true} image={avatar} />
            <View style={{
                flex: 2,
            }}>
                <View style={{paddingTop: 5}}>
                    ...
                    <TouchableOpacity>
                        <Text style={{fontSize: 15}}>{scheduleInfo.equipe.nomeApresentacao}</Text>
                        <Text style={{fontSize: 11}}>??</Text>
                        <Text style={{fontSize: 11}}>{scheduleInfo.equipe.bairro}/{scheduleInfo.equipe.cidade}</Text>
                    </TouchableOpacity>
                    <View>
                    <TouchableOpacity style={{marginBottom: 5,
                        ...
                        <Image source={imgTime} style={{marginRight: 5, width: 16, height: 16}}></Image>
                    ...
                    <TouchableOpacity style={{marginBottom: 5,
                        ...
                        <Image source={imgHourglass} style={{marginRight: 5, width: 16, height: 16}}></Image>
                        <Text style={{fontSize: 11}}>{scheduleInfo.painel.diasUltimoAcesso}</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={{marginBottom: 5,
                        flexDirection: 'row',
                        flexWrap: 'wrap',
                        ...
                        <Image source={imgRoad} style={{marginRight: 5, width: 16, height: 16}}></Image>
                        <Text style={{fontSize: 11}}>{scheduleInfo.painel.distancia}</Text>
                    </TouchableOpacity>
                    </View>
                </View>
                </View>
                ...
                <TouchableOpacity onPress={importantInformationHandle}>
                    <Image source={imgRisk} style={{width: 16, height: 16, marginRight: 5}}></Image>
                </TouchableOpacity>
                <TouchableOpacity onPress={detailedInformationHandle}>
                    <Image source={imgMarker} style={{width: 16, height: 16, marginRight: 5}}></Image>
                </TouchableOpacity>
                <TouchableOpacity onPress={evaluationHandle} style={{
                    flexDirection: 'row'
                }}>
                    <Image source={imgStar} style={{width: 16, height: 16, marginRight: 1}}></Image>
                    <Image source={imgStar} style={{width: 16, height: 16, marginRight: 1}}></Image>
                    <Image source={imgStar} style={{width: 16, height: 16, marginRight: 1}}></Image>
                    <Image source={imgStar} style={{width: 16, height: 16, marginRight: 1}}></Image>
                </TouchableOpacity>
                <TouchableOpacity style={{
                        ...
                        <Image source={imgTrophy} style={{width: 16, height: 16, marginRight: 5}}></Image>
                        <Text style={{fontSize: 11}}>{scheduleInfo.painel.rankingAtualAdversario}</Text>
                </TouchableOpacity>
                <TouchableOpacity>
